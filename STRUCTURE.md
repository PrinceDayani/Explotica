...
├── active/        ← web_fuzz, web_appscan, web_security, default_creds, takeover, subdomain_extended, smtp_test, container_scan, jwt_audit, graphql_audit, dom_xss, session_flows, idor_audit, web_cluster
