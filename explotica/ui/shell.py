...
class ExploticaShell(cmd.Cmd):
    ...
    def do_compliance(self, arg: str) -> bool:
        ...
        if not self._require_scan():
            return False
        from ..specialized.compliance import evaluate
    ...
    def do_dashboard(self, arg: str) -> bool:
        ...
        from ..output.dashboard import fastapi_available, serve
        ...
        for i, p in enumerate(parts):
            if p == "--depth" and i + 1 < len(parts):
                try:
                    ...
                    pass
        from ..discovery.network_spider import spider
    ...
    def do_plugins(self, arg: str) -> bool:
        ...
        from ..runtime.plugins import discover_plugins, all_probes, all_reports
